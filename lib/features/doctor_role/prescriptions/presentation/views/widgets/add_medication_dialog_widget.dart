...
class AddMedicationDialogWidget extends StatefulWidget {
  final Function(PrescriptionModel) onAdd;

  const AddMedicationDialogWidget({
    super.key,
    required this.onAdd,
  });

  @override
  State<AddMedicationDialogWidget> createState() =>
      _AddMedicationDialogWidgetState();
}

class _AddMedicationDialogWidgetState
    extends State<AddMedicationDialogWidget> {
